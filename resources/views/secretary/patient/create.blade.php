    ...
    <div class="flex h-screen w-screen">
        ...
        <div class="w-full md:w-1/2 flex flex-col justify-center items-center bg-white p-10 overflow-y-auto">
            <div class="w-full max-w-md" x-data="{ showPassword: false, showConfirm: false }">
                <!-- Form -->
                <form method="POST" action="{{ route('secretary.patient.store') }}" class="space-y-4">
                    @csrf
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" @click="showPassword = !showPassword"
                                class="absolute inset-y-0 right-3 text-gray-500 text-sm">
                                <svg x-show="!showPassword" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mt-2"
                        ...
                        <div class="relative">
                            ...
                            <button type="button" @click="showConfirm = !showConfirm"
                                class="absolute inset-y-0 right-3 text-gray-500 text-sm">
                                <svg x-show="!showConfirm" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mt-2"
                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5
