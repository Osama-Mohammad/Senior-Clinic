<x-layout>
    ...
    <section class="relative w-full h-[90vh] min-h-[500px]">
        ...
        <img src="{{ asset('photos/home.jpg') }}" alt="Doctors Team"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div x-data="{
                ...
                <div class="relative overflow-hidden rounded-xl shadow-lg">
                    <img :src="images[current]" alt="About Image"
                ...
                <div class="flex justify-center mt-4 space-x-2">
                    <template x-for="(img, index) in images" :key="index">
                        <div @click="current = index" :class="current === index ? 'bg-teal-600' : 'bg-gray-300'"
                ...
                @foreach ($clinics as $clinic)
                    <div class="bg-white rounded-lg shadow hover:shadow-md transition p-6">
                        ...
                        <p class="text-sm text-gray-500 mb-1">
                            <i class="fas fa-map-marker-alt text-teal-500 mr-1"></i> {{ $clinic->address }}
                        </p>
                        <p class="text-sm text-gray-500 mb-1">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach ($doctors as $doctor)
                    <div class="bg-gray-50 rounded-lg shadow hover:shadow-md transition p-6">
                        <h3 class="text-xl font-semibold text-gray-800 mb-2">{{ $doctor->first_name }}
                            {{ $doctor->last_name }}</h3>
                        ...
                        <p class="text-sm text-gray-600 mt-3">
                            <i class="fas fa-dollar-sign text-teal-500 mr-2"></i> Consultation Fee:
                            ${{ $doctor->price }}
                        </p>
                    </div>
                @endforeach
