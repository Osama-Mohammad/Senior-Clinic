        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach ($clinics as $clinic)
                    <div
                        class="bg-white rounded-lg shadow hover:shadow-xl hover:-translate-y-1 transition transform p-6">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach ($doctors as $doctor)
                    <div
                        class="bg-gray-50 rounded-lg shadow hover:shadow-xl hover:-translate-y-1 transition transform p-6">
                        <!-- 🖼️ Clinic Image -->
                        @if ($clinic->image)
