<x-admin-layout>
    <div class="min-h-screen bg-gradient-to-r from-cyan-50 to-blue-50 flex items-center justify-center py-12 px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="max_daily_appointments" id="max_daily_appointments" value="{{ old('max_daily_appointments', $doctor->max_daily_appointments) }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-teal-500 focus:border-teal-500 sm:text-sm">
                        @error('max_daily_appointments') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <template x-for="day in days" :key="day">
                            <div class="flex flex-col md:flex-row items-start md:items-center space-y-2 md:space-y-0 md:space-x-4 mb-3">
                                <label class="flex items-center space-x-2">
                                    <input type="checkbox" :value="day" @change="toggleDay(day, $event.target.checked)" :checked="selected(day)"
                                ...
                                <div x-show="schedule[day]" x-cloak class="flex flex-col md:flex-row space-y-1 md:space-y-0 md:space-x-2">
                                    <div>
                                        ...
                                        <select :name="`availability_schedule[${day}][from]`" x-model="schedule[day].from"
    ...
    <!-- Blade-side hidden error holders for From/To errors -->
