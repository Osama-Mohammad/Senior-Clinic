<x-admin-layout>
    ...
    <div class="bg-white shadow mb-6 rounded-xl p-4 flex items-center justify-between">
        <div class="flex items-center space-x-4">
            ...
            <h1 class="text-3xl font-bold text-blue-800 tracking-tight">MediBook Admin Dashboard</h1>
        </div>
    ...
    <div class="max-w-6xl mx-auto space-y-10 animate-fade-in">
        <div class="text-center space-y-4">
            ...
            <p class="text-gray-600 text-lg">
                Welcome back, Admin. Your command center for smart medical operations.
            </p>
        </div>
