        ...
        <div class="max-w-4xl w-full bg-white p-8 rounded-2xl shadow-2xl space-y-8 animate-fade-in">
            ...
            <form action="{{ route('doctor.update', $doctor) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="max_daily_appointments" class="block text-sm font-medium text-gray-700">Max Daily
                            Appointments</label>
                        <input type="text" name="max_daily_appointments" id="max_daily_appointments"
                            value="{{ old('max_daily_appointments', $doctor->max_daily_appointments) }}"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-teal-500 focus:border-teal-500 sm:text-sm">
                    ...
                    <div class="md:col-span-2" x-data="availabilityForm()">
                        ...
                        <template x-for="day in days" :key="day">
                            <div
                                ...
                                <div x-show="schedule[day]" x-cloak
                                    class="flex flex-col md:flex-row space-y-1 md:space-y-0 md:space-x-2">
                                    <div>
